...
res_table0_tb=gsub(",?Gm[^,]*,?", "", res_table0_tb$gene)
...
pheatmap(norm_sig0, scale = "row", clustering_distance_rows = "correlation", cutree_cols = 2, fontsize = 3, color = colorRampPalette(brewer.pal(9, "YlOrBr"))(255), cellwidth = 12.0, main = "0 h", cluster_cols = FALSE, gaps_col = c(3))
...
gse <- gseGO(gene = zero_foldchanges, 
                keyType = "SYMBOL",
                OrgDb = org.Mm.eg.db, 
                ont = "BP")
...
zero_foldchanges <- zero_foldchanges[which(abs(zero_foldchanges)>1.1)]
...
pheatmap(norm_sig4, scale = "row", clustering_distance_rows = "correlation", cutree_cols = 2, fontsize = 3, color = colorRampPalette(brewer.pal(9, "YlOrBr"))(255), cellwidth = 12.0, main = "0 h", cluster_cols = FALSE, gaps_col = c(3))
...
four_foldchanges <- four_foldchanges[which(abs(four_foldchanges)>1.5)]
...
```{r}
pheatmap(norm_sig8, scale = "row", clustering_distance_rows = "correlation", cutree_cols = 2, fontsize = 3, color = colorRampPalette(brewer.pal(9, "YlOrBr"))(255), cellwidth = 12.0, main = "0 h", cluster_cols = FALSE, gaps_col = c(3))
...
eight_foldchanges <- eight_foldchanges[which(abs(eight_foldchanges)>1.5)]
...
pheatmap(norm_sig24, scale = "row", clustering_distance_rows = "correlation", cutree_cols = 2, fontsize = 3, color = colorRampPalette(brewer.pal(9, "YlOrBr"))(255), cellwidth = 12.0, main = "0 h", cluster_cols = FALSE, gaps_col = c(3))
```
