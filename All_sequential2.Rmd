...
sig0 <- res_table0_tb[which(abs(res_table0_tb[,3])>1.1),]
...
gsea0=gseaplot(gse0, by = "all", title = gse0$Description[1], geneSetID = 1)
...
gsea4=gseaplot(gse4, by = "all", title = gse4$Description[1], geneSetID = 1)
...
gsea8=gseaplot(gse8, by = "all", title = gse8$Description[1], geneSetID = 1)
...
gsea24=gseaplot(gse24, by = "all", title = gse24$Description[1], geneSetID = 1)
...
sizeFactors(dds)
rld=vst(dds)
plotPCA(rld, intgroup=c("treatment","timee"))
...
normalized_counts=normalized_counts[,1:23]
