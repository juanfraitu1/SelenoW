...
four_foldchanges <- four_foldchanges[which(abs(four_foldchanges)>1.1)]
...
dotplot(gse8)
=======
dotplot(gse8, showCategory=10, split=".sign") + facet_grid(.~.sign)
>>>>>>> Stashed changes
...
dotplot(gse24)
=======
dotplot(gse24, showCategory=10, split=".sign") + facet_grid(.~.sign)
>>>>>>> Stashed changes
