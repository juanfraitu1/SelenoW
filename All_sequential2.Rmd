...
sig0 <- res_table_tb0[which(res_table_tb0[,7]<0.05 & abs(res_table_tb0[,3])>1.5),]
...
sig4 <- res_table_tb4[which(res_table_tb4[,7]<0.05 & abs(res_table_tb4[,3])>1.5),]
...
sig8 <- res_table_tb8[which(res_table_tb8[,7]<0.05 & abs(res_table_tb8[,3])>1.5),]
...
sig24 <- res_table_tb[which(res_table_tb24[,7]<0.05 & abs(res_table_tb24[,3])>1.5),]
