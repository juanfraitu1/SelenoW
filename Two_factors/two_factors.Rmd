...
res_table=results(dds, contrast=list("group_KO24_vs_KO0","group_KO4_vs_KO0","group_KO8_vs_KO0","group_WT0_vs_KO0","group_WT24_vs_KO0","group_WT4_vs_KO0","group_WT8_vs_KO0"))
...
a=lapply(1:30, function(i) {gseaplot(gse, by = "all", title = gse$Description[i], geneSetID = i)})
...
pdf("kegg_dotplot.pdf", width=10, height=30)
print(kegg)
dev.off()
