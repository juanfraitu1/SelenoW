...
timee=c(rep("0",6),rep("4",6),rep("8",6),rep("24",5))
colData=as_tibble(cbind(colnames(countData),factor(treatment,levels=c("KO","WT"),ordered = FALSE),factor(timee,levels = c("0","4","8","24"))))
...
dds=DESeq(dds, test = "LRT", reduced=~timee+treatment)
