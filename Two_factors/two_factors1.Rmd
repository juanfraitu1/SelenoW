...
##dotplot(gse_base)+scale_y_discrete(labels=function(x) str_wrap(x, width=80))+scale_size_area(max_size = 5)

go_base=go(ko_base_genelist)

dotplot(go_base)+scale_y_discrete(labels=function(x) str_wrap(x, width=80))+scale_size_area(max_size = 5)

kgg_base=kgg(ko_base_genelist)

##dotplot(kgg_base)+scale_y_discrete(labels=function(x) str_wrap(x, width=80))+scale_size_area(max_size = 5)

reactom_base=reactom(ko_base_genelist)

dotplot(reactom_base)+scale_y_discrete(labels=function(x) str_wrap(x, width=80))+scale_size_area(max_size = 5)
...
dotplot(go_mer, showCategory=25, font.size=7)+scale_y_discrete(labels=function(x) str_wrap(x, width=80))+scale_size_area(max_size = 5)


gsea_mer=merge_result(list("4"=gse4h_0,"8"=gse8h_0,"24"=gse24h_0))

dotplot(gsea_mer, showCategory=25, x="NES",font.size=7)+facet_grid(~Cluster)+scale_y_discrete(labels=function(x) str_wrap(x, width=80))+scale_size_area(max_size = 5)
...
dotplot(kgg_mer, showCategory=25, x="NES", font.size=7)+facet_grid(~Cluster)+scale_y_discrete(labels=function(x) str_wrap(x, width=80))+scale_size_area(max_size = 5)
...
dotplot(reac_mer, showCategory=25, font.size=7)+facet_grid(~Cluster)+scale_y_discrete(labels=function(x) str_wrap(x, width=150))+scale_size_area(max_size = 5)
...
dotplot(go_mer, showCategory=25, font.size=7)+scale_y_discrete(labels=function(x) str_wrap(x, width=140))+scale_size_area(max_size = 5)


gsea_mer=merge_result(list("4"=gse4h,"8"=gse8h,"24"=gse24h))

##dotplot(gsea_mer, showCategory=25, font.size=7)+facet_grid(~Cluster)+scale_y_discrete(labels=function(x) str_wrap(x, width=80))+scale_size_area(max_size = 5)



kgg_mer=merge_result(list("4"=kgg_4h,"8"=kgg_8h,"24"=kgg_24h))

dotplot(kgg_mer, showCategory=25, x="NES", font.size=7)+facet_grid(~Cluster)+scale_y_discrete(labels=function(x) str_wrap(x, width=140))+scale_size_area(max_size = 5)
...
dotplot(reac_mer, showCategory=50, font.size=7)+facet_grid(~Cluster)+scale_y_discrete(labels=function(x) str_wrap(x, width=140))+scale_size_area(max_size = 5)
...
dotplot(goLRT, showCategory=25, font.size=7)+scale_y_discrete(labels=function(x) str_wrap(x, width=80))+scale_size_area(max_size = 5)


gseLRT <- gse(LRT_genelist)


dotplot(gseLRT, showCategory=25, font.size=7, x="NES")+scale_y_discrete(labels=function(x) str_wrap(x, width=80))+scale_size_area(max_size = 5)
...
dotplot(kggLRT_, showCategory=25, x="NES")+scale_y_discrete(labels=function(x) str_wrap(x, width=80))+scale_size_area(max_size = 5)


reactomLRT_=reactom(LRT_genelist)

dotplot(reactomLRT_, showCategory=25)+scale_y_discrete(labels=function(x) str_wrap(x, width=80))+scale_size_area(max_size = 5)
...
# 
# 
# go_dp=dotplot(go, showCategory=60)+scale_y_discrete(labels=function(x) str_wrap(x, width=80))+scale_size_area(max_size = 5)
...
# 
# gsea=dotplot(gse, showCategory=50, split=".sign") + facet_grid(.~.sign)+scale_y_discrete(labels=function(x) str_wrap(x, width=80))+scale_size_area(max_size = 5)
...
# 
# 
# dotplot(kgg , showCategory=25, split=".sign", x="NES", decreasing = TRUE,font.size=6)+scale_y_discrete(labels=function(x) str_wrap(x, width=80))+scale_size_area(max_size = 5)
