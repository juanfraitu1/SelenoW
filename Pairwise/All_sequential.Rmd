...
sig0 <- res_table0_tb[which(res_table0_tb[,6]<0.05 & abs(res_table0_tb[,3])>3),]
...
sig4 <- res_table4_tb[which(res_table4_tb[,6]<0.05 & abs(res_table4_tb[,3])>3),]
...
sig8 <- res_table8_tb[which(res_table8_tb[,6]<0.05 & abs(res_table8_tb[,3])>3),]
...
sig24 <- res_table24_tb[which(res_table24_tb[,6]<0.05 & abs(res_table24_tb[,3])>3),]
