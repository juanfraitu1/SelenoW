...
hea4=pheatmap(norm_sig4, scale = "row", clustering_distance_rows = "correlation", cutree_cols = 2, fontsize = 3, color = colorRampPalette(brewer.pal(9, "YlOrBr"))(255), cellwidth = 12.0, main = "4 h", cluster_cols = FALSE, gaps_col = c(3))


pdf("heatmap4.pdf", height = 31)
print(hea4)
dev.off()
```
...
```{r}
hea8=pheatmap(norm_sig8, scale = "row", clustering_distance_rows = "correlation", cutree_cols = 2, fontsize = 3, color = colorRampPalette(brewer.pal(9, "YlOrBr"))(255), cellwidth = 12.0, main = "8 h", cluster_cols = FALSE, gaps_col = c(3))
...
hea24=pheatmap(norm_sig24, scale = "row", clustering_distance_rows = "correlation", cutree_cols = 2, fontsize = 3, color = colorRampPalette(brewer.pal(9, "YlOrBr"))(255), cellwidth = 12.0, main = "24 h", cluster_cols = FALSE, gaps_col = c(3))
